	...
	<div class="section col s12 m12 l10 bodybox">
		...
		<div id="supervision-introduction-cat2" class="section scrollspy">
			...
			<ul class="collection">
				...
				<li class="nopadding collection-item"><span class="icon-history"></span> <span class="title"><strong>Historique</strong> : Visualisation des positions brutes des véhicules (jour par jour)</span></li>
				<li class="nopadding collection-item"><span class="icon-providers"></span> <span class="title"><strong>Terminaux</strong> : Liste des terminaux autorisés sur le secteur</span></li>
			...
			<blockquote class="gold">Option : options payantes, voir avec votre Chef de projet Zenbus</blockquote>
		</div>
	</div>
